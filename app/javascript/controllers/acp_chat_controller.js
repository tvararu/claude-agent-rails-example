...
export default class extends Controller {
  ...
  handleMessage(data) {
    if (data.type === "user") {
      ...
      this.appendMessage("tool", data.content)
  ...
  handleConnected() {
    console.log("Connected to Agent::AcpChannel")
  }

  handleDisconnected() {
    console.log("Disconnected from Agent::AcpChannel")
  }
  ...
  getMessageClass(type) {
    ...
    switch(type) {
      ...
      case "tool":
        return `${base} bg-yellow-100 text-yellow-900 max-w-3xl`
      case "error":
